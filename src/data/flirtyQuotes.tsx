export const flirtyQuotes = [
  ...
  "Tired of being an adult? Then be my baby",
...
export function getRandomFlirtyQuote() {
  return flirtyQuotes[Math.floor(Math.random() * flirtyQuotes.length)];
}
